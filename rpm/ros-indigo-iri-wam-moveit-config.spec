Name:           ros-indigo-iri-wam-moveit-config
Version:        1.0.7
Release:        0%{?dist}
Summary:        ROS iri_wam_moveit_config package
...
Requires:       ros-indigo-ompl-visual-tools
BuildRequires:  ros-indigo-catkin

%description
An automatically generated package with all the configuration and launch files
for using the iri_wam with the MoveIt Motion Planning Framework
